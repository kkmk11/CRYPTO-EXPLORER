...
const Signup = () => {
  ...
  <div className="row px-3 justify-content-center">
      <div className="card col-sm-4 bg-l rounded" style={{ backgroundColor: "aliceblue" ,height:"480px"}} >
      <center >
        <br/>
          ...
          <small className='text-danger'>*Note : Password must have atleast 8 characters</small><br/><br/>
